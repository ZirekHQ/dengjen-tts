...
/**
 * MemoryLayouts mirroring the C structs in libdengjen.h
 * (crates/frontends/capi/libdengjen.h). Pure metadata -- constructing these
 * does not load the native library, unlike DengjenLib.
 */
final class DengjenLayouts {
    ...
    static final GroupLayout PIPER_SYNTH_CONFIG = MemoryLayout.structLayout(
    ...
    static final GroupLayout AUDIO_INFO = MemoryLayout.structLayout(
            JAVA_INT.withName("sample_rate"),
            JAVA_INT.withName("num_channels"),
            JAVA_INT.withName("sample_width")
    ).withName("AudioInfo");
    static final long AUDIO_INFO_SAMPLE_RATE_OFFSET = AUDIO_INFO.byteOffset(PathElement.groupElement("sample_rate"));
    static final long AUDIO_INFO_NUM_CHANNELS_OFFSET = AUDIO_INFO.byteOffset(PathElement.groupElement("num_channels"));
    static final long AUDIO_INFO_SAMPLE_WIDTH_OFFSET = AUDIO_INFO.byteOffset(PathElement.groupElement("sample_width"));

    static final GroupLayout SYNTHESIS_EVENT = MemoryLayout.structLayout(
    ...
    static final long SYNTHESIS_EVENT_TYPE_OFFSET = SYNTHESIS_EVENT.byteOffset(PathElement.groupElement("event_type"));
    static final long SYNTHESIS_EVENT_ERROR_PTR_OFFSET =
            SYNTHESIS_EVENT.byteOffset(PathElement.groupElement("error_ptr"));
    static final long SYNTHESIS_EVENT_LEN_OFFSET = SYNTHESIS_EVENT.byteOffset(PathElement.groupElement("len"));
    static final long SYNTHESIS_EVENT_DATA_OFFSET = SYNTHESIS_EVENT.byteOffset(PathElement.groupElement("data"));

    static final GroupLayout SYNTHESIS_PARAMS = MemoryLayout.structLayout(
    ...
    static final long SYNTHESIS_PARAMS_MODE_OFFSET = SYNTHESIS_PARAMS.byteOffset(PathElement.groupElement("mode"));
    static final long SYNTHESIS_PARAMS_RATE_OFFSET = SYNTHESIS_PARAMS.byteOffset(PathElement.groupElement("rate"));
    static final long SYNTHESIS_PARAMS_VOLUME_OFFSET = SYNTHESIS_PARAMS.byteOffset(PathElement.groupElement("volume"));
    static final long SYNTHESIS_PARAMS_PITCH_OFFSET = SYNTHESIS_PARAMS.byteOffset(PathElement.groupElement("pitch"));
