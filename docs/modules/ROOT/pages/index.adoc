...
The pinyin phonemizer needs the `pinyin` Cargo feature; the released `dengjen-tts-grpc` build does not
include it. See xref:voices.adoc[Choosing and tuning a model backend] and
