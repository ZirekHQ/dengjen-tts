//! Hand-written FFI bindings for the three espeak-ng C functions this crate calls.
//! Signatures and constants verified against
//! `deps/espeak-ng/src/include/espeak/speak_lib.h`.
